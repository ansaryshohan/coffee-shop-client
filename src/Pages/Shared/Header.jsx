    ...
    <div className="w-full bg-headerBg bg-center bg-cover bg-no-repeat">
      <div className="flex justify-between items-center gap-5  container mx-auto">
        <div className="flex justify-center items-center gap-5">
          ...
          <div>
            <h1 className="text-[#FFFFFF] font-semibold text-2xl uppercase">
              Espresso Emporium
            </h1>
          </div>
        </div>
        <div className="flex gap-10 text-[#FFFFFF] font-semibold text-2xl uppercase">
        ...
        <div>
          {
            <button className="bg-buttonColor text-primaryTextColor px-2 py-2 rounded-lg text-xl uppercase font-bold hover:text-cardBgColor">
